...
test('should ignore null input', (t) => {
  const children = [];
  JsonTree.visit(null, (value: any): void => {
    children.push(value);
  });
...
test('should visit array children', (t) => {
  const children = [];
  JsonTree.visit(['a', 'b', 'c'], (value: any): void => {
    children.push(value);
  });
...
test('should visit object properties', (t) => {
  const children = [];
  JsonTree.visit({ a: 'a', b: 'b', c: 'c' }, (value: any): void => {
    children.push(value);
  });
  t.deepEqual(children, ['a', 'b', 'c']);
});
...
test('should recursively visit object properties', (t) => {
  const children = [];
  JsonTree.visit({ a: { a: 'a' }, b: 'b', c: 'c' }, (value: any): void => {
    children.push(value);
  });
